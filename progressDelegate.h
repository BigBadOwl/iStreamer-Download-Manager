...
- (void)ipFetch:(iplayerFetch *)ipFetch didReceiveBytes:(long long)bytes;
...
- (void)ipFetch:(iplayerFetch *)ipFetch didSendBytes:(long long)bytes;

// Called when a request needs to change the length of the content to download
- (void)ipFetch:(iplayerFetch *)ipFetch incrementDownloadSizeBy:(long long)newLength;

// Called when a request needs to change the length of the content to upload
// newLength may be less than zero when a request needs to remove the size of the internal buffer from progress tracking
- (void)ipFetch:(iplayerFetch *)ipFetch incrementUploadSizeBy:(long long)newLength;
@end
